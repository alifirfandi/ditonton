...
import 'package:movie/data/datasource/db/database_helper_movie.dart' as _i14;
import 'package:movie/data/datasource/movie_local_data_source.dart' as _i12;
import 'package:movie/data/datasource/movie_remote_data_source.dart' as _i10;
...
class MockDatabaseHelperMovie extends _i1.Mock
  ...
  _i6.Future<int> removeWatchlistMovie(_i13.MovieTable? movie) =>
      (super.noSuchMethod(Invocation.method(#removeWatchlistMovie, [movie]),
          returnValue: Future<int>.value(0)) as _i6.Future<int>);
  @override
  _i6.Future<Map<String, dynamic>?> getByMovieId(int? id) =>
      (super.noSuchMethod(Invocation.method(#getByMovieId, [id]),
